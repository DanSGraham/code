...
class DanielGrahamWizard1(Wizard):
    ...
    def runAway(self, worldGrid, adjacent, direction_conversions, missile = None ):
        ...
        if missile != None and (missile in moveList):
    ...
    def chooseAction(self, locationX, locationY, currentlyFacing, lineOfSight, worldGrid, missileRechargeCounter):
        ...
        #CURRENTLY RUNS AWAY FROM MISSILES TO OPEN SPACE. HERE ARE SCENERIOS THAT WOULD RESULT IN DEATH:
            #IF TWO MISSILES STRIKE AT SAME TIME
            #IF BOXED IN ON ALL FOUR SIDES BY POTENTIAL MISSILES OR PLAYERS
