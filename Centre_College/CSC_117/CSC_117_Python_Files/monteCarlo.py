...
def mainGUI():
    ...
    prompt_entry = Entry(Point(0.9,-1.25), 8)
    ...
    pi_approx = inside_circle/(inside_circle+outside_circle)*4
    text_string = "Accoriding to this approximation pi = " + str(pi_approx)

    end_text = Text(Point(0,-1.25), text_string)
    end_text.draw(win)
