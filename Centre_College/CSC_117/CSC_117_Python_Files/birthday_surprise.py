...
def shut_up():
    ...
    su_eye1.undraw()
    su_eye2.undraw()
    explosion = Image(Point(250,250),"Explosion.gif")
...
def bake_cake():
    ...
    cake_window = GraphWin("Bday Cake", 500,500)
    cake = Image(Point(250,250), 'Palm tree cake.gif') #gettin lazy...
    cake.draw(cake_window)
    time.sleep(10)
    cake.undraw()

    explosion = Image(Point(250,250),"Explosion.gif")
    explosion.draw(cake_window)
    time.sleep(0.5)
    explosion.undraw()
...
def stroke_snake():
    ...
    snake_window = GraphWin("Bday Snake", 500,500)
    snake = Image(Point(250,250), 'Snake.gif') #gettin lazy...
    snake.draw(snake_window)
    time.sleep(10)
    snake.undraw()

    explosion = Image(Point(250,250),"Explosion.gif")
    explosion.draw(snake_window)
    time.sleep(0.5)
    explosion.undraw()
...
def main():
    ...
    if desires == "Shut up":
        shut_up()
    if desires == "Stroke my snake":
        stroke_snake()
    if desires == "Bake a cake":
        bake_cake()
    
    while True:
        print "Happy Birthday, Snake Charmer!"
